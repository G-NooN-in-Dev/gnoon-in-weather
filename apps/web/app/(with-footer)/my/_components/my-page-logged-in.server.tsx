...
import MyPageAccountDeleteServer from '@/app/(with-footer)/my/_components/my-page-account-delete.server'
import MyPageFavoriteLocationsServer from '@/app/(with-footer)/my/_components/my-page-favorite-locations.server'
import MyPageFavoritePressListsServer from '@/app/(with-footer)/my/_components/my-page-favorite-press-lists.server'
import {
