/** 외부 API 공급자 식별자 */
type AppApiErrorProvider = 'weatherapi' | 'kakao' | 'naver'

/** 앱에서 공통으로 사용하는 HTTP 에러 상태 */
type AppApiErrorStatus = 400 | 401 | 403 | 404 | 500 | 502 | 503 | 504
...
export type { AppApiError, AppApiErrorProvider, AppApiErrorRule, AppApiErrorStatus }
